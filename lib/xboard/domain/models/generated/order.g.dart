...
_DomainOrder _$DomainOrderFromJson(Map<String, dynamic> json) => _DomainOrder(
  ...
  commissionStatus: $enumDecodeNullable(
    _$OrderCommissionStatusEnumMap,
...
Map<String, dynamic> _$DomainOrderToJson(
  _DomainOrder instance,
) => <String, dynamic>{
  ...
  'commissionStatus': _$OrderCommissionStatusEnumMap[instance.commissionStatus],
