...
# Ensure leaf.xcframework reference exists (generated by scripts/ios/build_leaf_xcframework.sh)
leaf_framework_ref = frameworks_group.files.find { |f| f.path == 'Frameworks/leaf.xcframework' } ||
  frameworks_group.new_file('Frameworks/leaf.xcframework')
...
unless packet_target.frameworks_build_phase.files_references.include?(leaf_framework_ref)
  packet_target.frameworks_build_phase.add_file_reference(leaf_framework_ref)
end
